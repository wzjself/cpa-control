...
function renderCredentialStore(credentials = [], cpas = []) {
  ...
  els.credentialStoreList.innerHTML = filtered.map(item => {
    ...
    const presenceTags = presentIn.length
      ...
      : '<span class="presence-tag pending">未在任何 CPA 中发现</span>';
    return `
